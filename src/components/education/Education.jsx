...
const Education = () => {
  return (
    <section  id="education" className="py-20 bg-gray-900">
      <div className="max-w-6xl mx-auto ml-4 px-6">
        <h2 className="text-4xl font-extrabold text-white text-center mb-12">Education</h2>
        <div className="relative border-l-4 border-blue-500 pl-6 lg:ml-12">
          {educationData.map((edu, index) => (
            <motion.div
              ...
              className="mb-10    ml-4  lg:ml-0  relative group hover:scale-105 transition-transform duration-300"
            >
              {/* Colorful Icon */}
              <div className={`absolute -left-[65px] lg:-left-[50px] bg-gray-800 ${edu.iconColor} w-10 h-10 flex items-center justify-center rounded-full shadow-lg shadow-blue-500/50`}>
